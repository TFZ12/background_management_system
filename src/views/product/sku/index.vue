<template>
  <el-card>
    ...
    <el-pagination v-model:current-page="pageNo" v-model:page-size="pageSize" :page-sizes="[10, 20, 30, 40]"
      ...
      @size-change="hander" />
    <el-drawer v-model="drawer" direction="rtl" style="width: 300px;">
      <template #header>
        <h4>查看商品详情</h4>
      </template>
      <template #default>
        ...
        <el-row style="margin: 10px 0;">
          ...
          <el-col :span="18">
            <el-carousel indicator-position="outside" :interval="4000" type="card" height="150px">
...
import { reqSkuList, reqSaleSku, reqCanceSale, reqSkuInfo, reqRemoveSku } from '@/apis/product/sku'
import { SkuData } from '@/apis/product/sku/type'
...
const updateSale = async (row: SkuData) => {
  if (row.isSale == 1) {
    await reqCanceSale((row.id as number))
    ElMessage({
      type: "success",
      message: '下架成功'
    })
